...
import { HttpClientResponse, HttpClientResponseR } from '@core/models/http-response.model';
...
export abstract class HttpService {
  ...
  public getWithParams(url: string, param: HttpParams): Observable<HttpClientResponse> {
