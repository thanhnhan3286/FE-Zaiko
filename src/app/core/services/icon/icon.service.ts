...
export class IconService {
  ...
  public init(): void {
    ...
    this.iconRegistry.addSvgIcon('icon-chervon-down', this.sanitizer.bypassSecurityTrustResourceUrl(domain + '/assets/icon-svg/chervon-down.svg'));
    this.iconRegistry.addSvgIcon('icon-chervon-up', this.sanitizer.bypassSecurityTrustResourceUrl(domain + '/assets/icon-svg/chervon-up.svg'));
  }
}
