...
export const MENU_DATA: Array<ISideMenuNode> = [
  {
    ...
    route: '/dashboard/supplement-list',
    router: '/dashboard',
    order: 1,
    level: 1,
    children: [
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        category: 'receipt',
        name: 'common.menu.receipt.inventory-input-actual-title',
        route: '/receipt/inventory-input-correction',
        order: 3,
        children: [],
        hidden: true
      },
  ...
  },
  {
    ...
    children: [
      ...
      // delivery/inventory-output-list
      {
        id: '302',
        level: 2,
        icon: 'icon-product',
      ...
      // delivery/inventory-output-plan
      {
        id: '303',
        level: 2,
        icon: 'icon-product',
      ...
      // delivery/inventory-output-actual
      {
        id: '304',
        level: 2,
        icon: 'icon-list',
      ...
      },
      {
        ...
        category: 'delivery',
        name: 'common.menu.delivery.reserve-allocation',
        route: '/delivery/inventory-output-correction',
        order: 13,
        children: [],
        hidden: true
      }
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        category: 'inventory',
        name: 'common.menu.inventory.set-product-inventory',
        route: '/inventory/set-product-inventory-detail',
        order: 1,
        children: [],
        hidden: true
      },
      {
        ...
        category: 'inventory',
        name: 'common.menu.inventory.set-product-inventory',
        route: '/inventory/set-product-inventory-register',
        order: 1,
        children: [],
        hidden: true
      }
