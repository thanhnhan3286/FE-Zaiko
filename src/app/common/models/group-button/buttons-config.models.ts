...
export interface CheckBoxSearchDetailModel{
  id:string,
...
export interface ISearchCommon {
  ...
  isDialogApi?: boolean,
  isHidden?: boolean;
  isClearDropList? :boolean,
  checkBoxList? : Array<CheckBoxSearchDetailModel>
}
...
export class CheckBoxSearch implements ISearchCommon {
  ...
  public constructor(
    ...
    public name: string,
    public width: number,
    public checkBoxList: Array<CheckBoxSearchDetailModel>,
...
export class DropListFromToSearch implements ISearchCommon {
  ...
  public constructor(
    ...
    public format?: number | string,
    public isHidden?: boolean,
    public isClearDropList? :boolean
  ) { }
}
...
export class ButtonConfig implements IButtonConfig {
  public constructor(
    ...
    public btnExportCsvSearch: boolean = false
  ) { }
}
