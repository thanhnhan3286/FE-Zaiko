...
export class Utils {
  ...
  public static getMessError(error: ValidationErrors | null | undefined, fieldName?: string, fieldNameFrom?: string, fieldNameTo?: string): string {
    ...
    switch (keyError) {
      ...
      case 'dateInvalidFrom':
        mess = `${fieldNameFrom}Fromは${fieldNameTo}To以下の値を指定してください。`;
        break;

      case 'dateInvalidTo':
        mess = `${fieldNameTo}Toは${fieldNameFrom}From以上の値を指定してください。`;
        break;
